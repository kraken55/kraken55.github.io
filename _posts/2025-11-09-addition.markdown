...
The previous couple of properties concerning the order of terms in addition were introduced to get you thinking about the
...
You can technically use the above properties to reason through why these rearrangements are correct,
